    ...
    <div class="container">
        <div class="row my-5">
            <div class="col-md-6 text-center login" style="background-image: url('/img/memphis-colorful.png');">
                <h4 class="fw-bold">Login | Peminjam</h4>
                <!-- Ini Error jika tidak bisa login -->
                <form action="<?php echo base_url('/peminjam/logon'); ?>" method="post">
                    ...
                    <div class="form-group my-5">
                        ...
                        <a href="<?= base_url('peminjam/registerpage') ?>">User baru? register sekarang</a>
                    </div>
